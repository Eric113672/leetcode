...
单独翻译对 f(i) 的贡献为 f(i - 1)；如果第 i - 1 位存在，并且第 i - 1位和第 i 位形成的数字 x 满足 10 \leq x \leq 2510≤x≤25，那么就可以把第 i - 1i−1 位和第 ii 位连起来一起翻译，对 f(i)f(i) 的贡献为 f(i - 2)f(i−2)，否则为 0。我们可以列出这样的动态规划转移方程：
